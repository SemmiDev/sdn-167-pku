...
class AtributController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.atribut.index')->with('success', 'Data atribut berhasil ditambahkan');
        } catch (\Exception $e) {
    ...
    public function destroy(Atribut $atribut) {
        try {
            $atribut->delete();
            return redirect()->route('admin.atribut.index')->with('success', 'Data atribut berhasil dihapus');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, Atribut $atribut) {
        try {
            ...
            return redirect()->route('admin.atribut.index')->with('success', 'Data atribut berhasil diubah');
        } catch (\Exception $e) {
