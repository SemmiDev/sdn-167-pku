...
class KategoriPengaduanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.kategori-pengaduan.index', compact('daftarKategoriPengaduan'));
    }
    ...
    public function update(Request $request, KategoriPengaduan $kategoriPengaduan) {
        try {
            ...
            return redirect()->route('admin.kategori-pengaduan.index')->with('success', 'Kategori Pengaduan berhasil diubah');
        } catch (\Exception $e) {
