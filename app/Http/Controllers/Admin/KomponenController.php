...
class KomponenController extends Controller
{
    public function index()
    {
        ...
        return view('admin.komponen.index', compact('daftarKomponen'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.komponen.index')->with('success', 'Data komponen berhasil ditambahkan');
        } catch (\Exception $e) {
    ...
    public function destroy(Komponen $komponen) {
        try {
            $komponen->delete();
            return redirect()->route('admin.komponen.index')->with('success', 'Data komponen berhasil dihapus');
        } catch (\Exception $e) {
    ...
    public function update(Request $request, Komponen $komponen) {
        try {
            ...
            return redirect()->route('admin.komponen.index')->with('success', 'Data komponen berhasil diubah');
        } catch (\Exception $e) {
