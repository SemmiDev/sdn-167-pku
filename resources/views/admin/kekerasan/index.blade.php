            ...
            @foreach($daftarKekerasan as $kekerasan)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        <a href="{{ route('admin.kekerasan.edit', $kekerasan->id) }}" class="edit-kekerasan w-20 focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">
                            Edit
                        </a>

                        <form action="{{ route('admin.kekerasan.destroy', $kekerasan->id) }}" method="post"
                              class="inline-block">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
