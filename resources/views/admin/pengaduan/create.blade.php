<x-admin-layout>
    <form method="POST"
        ...
        <div class="mb-6">
            <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Pengadu</label>
        ...
        <div class="flex items-center justify-center w-full mb-5">
            <label for="dropzone-file"
                ...
                <div id="zone" class="flex flex-col items-center justify-center pt-6 pb-6">
                    ...
                    <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Tekan untuk upload</span>
