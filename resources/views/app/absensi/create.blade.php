<x-admin-layout>
    <form class="space-y-6" action="{{ route('app.absensi.store') }}" method="post">
        ...
        <div>
            <label for="komponen" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Komponen
        ...
        <div>
            <label for="atribut" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Atribut
                <span class="text-red-500">*</span>
            </label>
