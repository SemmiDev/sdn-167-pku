<x-admin-layout>
    <div class="flex justify-between">
        ...
        <div>
            <button data-modal-target="tambah-komponen-modal" data-modal-toggle="tambah-komponen-modal"
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <tbody>
                @foreach ($daftarKomponen as $komponen)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button data-id="{{ $komponen->id }}" data-nama="{{ $komponen->nama }}"
                                data-keterangan="{{ $komponen->keterangan }}" data-modal-target="edit-komponen-modal"
                            ...
                            <form action="{{ route('app.komponen.destroy', $komponen->id) }}" method="post"
                                class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
        ...
        <div id="tambah-komponen-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        ...
                        data-modal-hide="tambah-komponen-modal">
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" action="{{ route('app.komponen.store') }}" method="post">
                            @csrf
                            <div>
                                <label for="nama"
        ...
        <div id="edit-komponen-modal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-md max-h-full">
                <!-- Modal content -->
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button type="button"
                        class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                        data-modal-hide="edit-komponen-modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form id="edit-komponen-form" class="space-y-6" method="post">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="nama_edit"
    ...
    <script type="text/javascript">
        $('.edit-komponen').click(function() {
            ...
            var url = "{{ route('app.komponen.update', ':komponen') }}";
