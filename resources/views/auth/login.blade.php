        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <main
                ...
                <div class="max-w-xl lg:max-w-md w-full p-6 rounded-xl shadow">
                    ...
                    <form action="{{ route('login') }}" method="post" class="mt-8 grid bg-white grid-cols-12 gap-6">
                        @csrf

                        <div class="col-span-12">
                            <label for="Email" required class="block text-sm font-medium text-gray-700">
                                Email
                            </label>

                            <input type="email" value="{{ old('email') }}" autofocus id="Email" name="email"
                                placeholder="ucup@gmail.com" required
