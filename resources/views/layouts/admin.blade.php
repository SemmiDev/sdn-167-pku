                                ...
                                <ul class="py-1" role="none">
                                    <li>
                                        <a href="{{ route('profile.edit') }}"
                                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-[#F2F7FF] dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
        ...
        <aside id="logo-sidebar"
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    ...
                    {{ request()->routeIs('admin.dashboard') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                            ">
                    ...
                    <li>
                        <a href="{{ route('admin.guru.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.guru.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                    ">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a href="{{ route('admin.siswa.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.siswa.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                    ">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.users.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                    ">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.komponen.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.komponen.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a href="{{ route('admin.atribut.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.atribut.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a href="{{ route('admin.pengumuman.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.pengumuman.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <li>
                        <a href="{{ route('admin.kategori-pengaduan.index') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-[#F2F7FF] dark:hover:bg-gray-700 group
                    {{ request()->routeIs('admin.kategori-pengaduan.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                       ">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li>
                        <a href="{{ route('admin.kekerasan.index') }}"
                            class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-[#F2F7FF] dark:hover:bg-gray-700 dark:text-white group
                    {{ request()->routeIs('admin.kekerasan.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}
                            ">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <a href="{{ route('admin.pengaduan.index') }}"
                            class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-[#F2F7FF] dark:hover:bg-gray-700 dark:text-white group
                    {{ request()->routeIs('admin.pengaduan.*') ? 'bg-[#F2F7FF] dark:bg-gray-700' : '' }}">
                            <svg class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
